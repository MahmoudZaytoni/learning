...
void WriteFileLines(const string& path, vector<string> &lines, bool append = true) {
...
vector<string> SplitString(const string &str, string dilemeter = "|") {
	string line = str;

	int pos = 0;
	vector<string> fields;
	while (pos = line.find(dilemeter) != -1) {
